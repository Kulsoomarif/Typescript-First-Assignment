...
//    different albums. Print each return value to show that Objects are 
//    storing the album information correctly. Add an optional parameter 
//    to make_album() that allows you to store the number of tracks on an 
//    album. If the calling line includes a value for the number of tracks,
...
let album2=make_album("Ali zafar","Huqqa Pani", 8)
let album3=make_album("Falak Shabbir","I,Me or main")
console.log(album1);
console.log(album2);
console.log(album3);
